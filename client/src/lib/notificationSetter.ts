...
export async function setSleepNotification() {
    try {
        ...
        await scheduleNotification(scheduleDate, "Bedtime", "Sleep is self-care too. Start winding down for bedtime");
...
export async function setMorningNotification() {
    try {
        ...
        await scheduleNotification(scheduleDate, "Good Morning!", "I hope you slept well! Good luck today!");
